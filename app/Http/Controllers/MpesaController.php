...
class MpesaController extends Controller
{
    ...
    public function checkBalance(){
      ...
      $balanceInquiry = $mpesa->accountBalance(
        ...
        $Initiator = config('app.MPESA_INITIATOR'),
        $SecurityCredential  = config('app.MPESA_SECURITY_CREDENTIAL'),
        $PartyA = config('app.MPESA_SHORT_CODE'),
        $IdentifierType = 4,
