              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="customer_stalls" class="table">
                      <thead>
                        <tr>
                            <th>Customer Stall ID</th>
                            <th>Customer ID</th>
                            <th>Stall Identifier</th>
                            <th>Stall Name</th>
                            <th>Stall Phone Number</th>
                      ...
                      <tbody>
                        @foreach($customer_stalls as $stall)
                        <tr>
                            <td>{{$stall->id}}</td>
                            <td>{{$stall->customer_id}}</td>
                            <td>{{$stall->stall_identifier}}</td>
                            <td>{{$stall->stall_name}}</td>
                            <td>{{$stall->stall_phone_number}}</td>
                            <td>{{$stall->postal_address}}</td>
                            <td>{{$stall->physical_location}}</td>
                            <td>{{$stall->geo_coordinates}}</td>
                            <td>{{$stall->shop_image_url}}</td>
                            <td>{{$stall->license_image_url}}</td>
                            <td>{{$stall->active}}</td>
                            <td>{{$stall->deleted}}</td>
                            ...
                            <td>
                              <form action="{{ route('persons.destroy', $person->id) }}" method="POST">
                                ...
                                <a class="btn btn-info" href="{{ route('customer_stalls.show', $customer_stall->id) }}">Show</a>

                                <a class="btn btn-primary" href="{{ route('customer_stalls.edit', $customer_stall->id) }}">Edit</a>
