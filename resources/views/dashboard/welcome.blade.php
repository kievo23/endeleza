                    ...
                    <div class="col-xl-3 col-md-6">
                      <div class="card bg-c-green update-card">
                        <div class="card-block">
                          <div class="row align-items-end">
                            <div class="col-8">
                              <h5 class="text-white">{{ number_format(($valueOfOutstandingLoans - $valueOfLoanPenaltyNotPaid), 2, '.', ',')}}</h5>
                      ...
                      <div class="card bg-c-green update-card">
                        <div class="card-block">
                          <div class="row align-items-end">
                            <div class="col-12">
                              <a href="{{ action('TransactionsController@index')}}">
                                <h5 class="text-white">@php echo number_format((($defaulters- $valueOfLoanPenaltyNotPaid)/$valueOfOutstandingLoans*100), 2, '.', ''); @endphp %</h5>
