        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">CUSTOMER TYPES</p>
                  <a href="{{ url('customer_types/create') }}" class="mr-2">
                  <button class="btn btn-primary btn-rounded btn-fw btn-icon-text pull-right">
                    <i class="mdi mdi-account-plus btn-icon-prepend"></i>
                     Create Customer Type 
                  </button>
                  </a>
                  <div class="table-responsive">
                    <table id="customer_types" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                            <th>Customer Type ID</th>
                            <th>Customer Type</th>
                            <th>Description</th>
                            <th>Minimum Account Balance</th>
                            <th>Active Status</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>{{$type->id}}</td>
                            <td>{{$type->customer_account_type}}</td>
                            <td>{{$type->description}}</td>
                            <td>{{$type->minimum_account_balance}}</td>
                            <td>{{$type->active}}</td>
                            <td>{{$type->deleted}}</td>
                            <td>
                              <form action="{{ route('customer_types.destroy', $type->CUSTOMER_TYPE_ID) }}" method="POST">
    
                                <a class="btn btn-info" href="{{ route('customer_types.show', $type->CUSTOMER_TYPE_ID) }}">Show</a>

                                <a class="btn btn-primary" href="{{ route('customer_types.edit', $type->CUSTOMER_TYPE_ID) }}">Edit</a>
