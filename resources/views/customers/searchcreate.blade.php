...
<html lang="en">
  ...
  <!-- <div class="container">
             ...
             <tr>
                <td colspan="1">
                   ...
                   {{ csrf_field() }}
                      ...
                      <legend>Customer Information Search</legend> -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="dateOfBirth" name="dateOfBirth" placeholder="dd/mm/yyyy" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div> -->
                         <!-- //This is the part that remained for searching
                         <div class="form-group">
                            <label class="col-md-4 control-label">ID Number</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="idNumber" name="idNumber" placeholder="ID Number" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div> -->
                         <!-- <div class="form-group">
                            <label class="col-md-4 control-label">Primary Mobile Number</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="primaryMobileNumber" name="primaryMobileNumber" placeholder="07..." class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            <label class="col-md-4 control-label">Alternate Mobile Number</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="alternateMobileNumber" name="alternateMobileNumber" placeholder="07..." class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
    ...
    <div class="container">
      <div class="col-md-4">      
      <form action="/customers/searchresults" method="get">
      <legend>Customer Information Search</legend>
         <div class="input-group">
